...
namespace GameEngine
{
    public static class PlayerMoveset
    {
        ...
        /// <summary>
        /// This is somewhat of a ressource file for all the possible move the player can use
        /// The only thing that is used is the attackLibrary dictionnary. All the others are compiled into it
        /// </summary>
        ...
        static public Dictionary<Vector2[], Action<Player>> attackLibrary = new Dictionary<Vector2[], Action<Player>>
        {
            ...
            //IF THERE'S A SIMPLIER MOVE WITH THE SAME START ON TOP OF IT, THE SIMPLIER MOVE WILL ALWAYS BE PLAYED INSTEAD
